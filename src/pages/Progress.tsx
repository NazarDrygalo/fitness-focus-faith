...
import { BarChart3, TrendingUp, Zap, Calendar, Target } from "lucide-react";
        ...
        {payload
          ...
          <div key={i} className="flex items-center gap-2 text-sm">
            ...
            <span className="font-semibold text-foreground">
              {entry.name === "Ladder %" ? `${entry.value}%` : entry.value}
            </span>
          </div>
        ))}
      </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <motion.div
          ...
          className="flex gap-1 mb-6 p-1 bg-secondary rounded-lg w-fit"
        >
                  ...
                  <ResponsiveContainer width="100%" height={360}>
                    <ComposedChart data={chartData} margin={{ top: 8, right: 8, left: -12, bottom: 0 }}>
                      ...
                      <Bar
                        ...
                        radius={[6, 6, 0, 0]}
                        name="Pushups"
                        barSize={range <= 7 ? 28 : range <= 30 ? 10 : 6}
                      ...
                      <Line
                        ...
                        strokeWidth={2.5}
                        dot={{ fill: "hsl(142, 50%, 45%)", r: 3, strokeWidth: 0 }}
